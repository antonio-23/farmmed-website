...
export const search_drug = (req, res) => {
    const q = "SELECT Identyfikator_Produktu_Leczniczego, Nazwa_Produktu_Leczniczego, Moc, Postać_farmaceutyczna, Podmiot_odpowiedzialny, Opakowanie, Substancja_czynna, Ilosc FROM farmmed.drugs WHERE Rodzaj_preparatu = 'Ludzki' AND (Nazwa_Produktu_Leczniczego LIKE ? OR Nazwa_Produktu_Leczniczego LIKE ? OR Nazwa_Produktu_Leczniczego LIKE ?) LIMIT 1000;";
